...
<div class="min-h-screen bg-bg-primary">
	...
	<header class="border-b border-surface-border">
		<div class="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
			<div class="flex items-center gap-3">
				...
				<span class="font-display font-semibold text-text-primary text-xl">spawner</span>
			</div>
			<nav class="flex items-center gap-6">
				<a href="/docs" class="text-sm text-text-secondary hover:text-text-primary transition-colors">Docs</a>
				<a href="https://github.com" class="text-sm text-text-secondary hover:text-text-primary transition-colors">GitHub</a>
			</nav>
		</div>
	</header>
	...
	<section class="max-w-6xl mx-auto px-6 pt-20 pb-16">
		...
		<div class="max-w-2xl mx-auto mb-20 animate-slide-up" style="animation-delay: 100ms;">
			<div
				class="relative rounded-xl border transition-all duration-normal"
			...
			>
				...
				<div class="flex items-center justify-between px-5 py-3 border-t border-surface-border">
					...
					<button
						...
						class="group flex items-center gap-2 px-4 py-2 bg-accent-primary text-bg-primary font-medium rounded-lg hover:bg-accent-primary-hover transition-all disabled:opacity-50 disabled:cursor-not-allowed"
					>
						<span>spawn()</span>
	...
	<section class="max-w-6xl mx-auto px-6 pb-20">
		<div class="grid md:grid-cols-2 gap-4">
			{#each tools as tool, i}
				<a
					href={tool.href}
					class="group relative p-6 bg-bg-secondary border border-surface-border rounded-xl hover:border-vibe-cyan-border hover:shadow-card-glow transition-all duration-normal animate-slide-up"
	...
	<footer class="border-t border-surface-border">
		<div class="max-w-6xl mx-auto px-6 py-8 flex items-center justify-between text-sm text-text-tertiary">
			<span>© 2025 Vibeship</span>
			<div class="flex items-center gap-6">
				<a href="/docs" class="hover:text-text-secondary transition-colors">Documentation</a>
				<a href="https://github.com" class="hover:text-text-secondary transition-colors">GitHub</a>
				<a href="/discord" class="hover:text-text-secondary transition-colors">Discord</a>
			</div>
		</div>
	</footer>
</div>
