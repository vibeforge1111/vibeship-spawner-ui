		...
		<div class="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
			<div class="flex items-center gap-6">
				...
				<nav class="hidden md:flex items-center gap-6">
					<a href="/guide" class="text-sm text-text-secondary hover:text-text-primary transition-colors">Guide</a>
					<a href="/skills" class="text-sm text-text-secondary hover:text-text-primary transition-colors">Skills</a>
				</nav>
			</div>
			<div class="flex items-center gap-4">
				<a href="https://github.com/vibeforge1111/spawner-ui" class="text-sm text-text-secondary hover:text-text-primary transition-colors flex items-center gap-1">
